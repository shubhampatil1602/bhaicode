  ...
  return (
    <div className='hidden lg:flex flex-col items-center justify-center bg-neutral-900 text-white p-12 relative overflow-hidden h-full'>
      ...
      <div className='z-10 max-w-lg w-full flex flex-col items-center'>
        {/* Code editor mockup */}
        <div className='w-full bg-neutral-800 rounded-lg shadow-xl mb-8 overflow-hidden'>
          {/* Editor header */}
        ...
        <div className='flex items-center justify-center mb-3'>
          <div className='w-10 h-10 rounded-xl bg-primary/10  flex items-center justify-center'>
            <Code2 className='w-6 h-6 text-neutral-200' />
          </div>
        </div>

        {/* Text content */}
        <h2 className='text-2xl text-neutral-200 font-bold mb-2 text-center'>
          {title}
        </h2>
